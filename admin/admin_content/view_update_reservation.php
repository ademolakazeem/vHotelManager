                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <tr>
                                  <!--td class="gradeX"-->
                                  <td>
                                      <a href="manage_ind_room_reservation.php?clt_id=<?php echo $rsRoom['room_reservation_id'];?>" title="Administer <?php echo $rsRoom['client_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
