...
$qry="SELECT * FROM room_feature_tbl";
                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-8 col-sm-8">
                                 <ol class="breadcrumb pull-right">
                                     ...
                                     <li class="active">Show Room Features</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Administer Accommodation Feature Information
                          </header>
                          <div class="panel-body">
                              ...
                              <tr>
                                  <!--td class="gradeX"-->
                                  <td>
                                      <a href="manage_room_feature.php?accfea_id=<?php echo $rsFea['feature_id'];?>" title="Administer <?php echo $rsFea['feature_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>


                                  </td>
                                  <td><?php echo $rsFea['feature_name'];?></td>
                                  <td><?php echo $rsFea['full_description'];?></td>

                                  <?php

                                  $dispDiscount=str_replace(',', '', $rsFea['discount']);
                                  $dispRate=str_replace(',', '', $rsFea['rate']);
                                  $dispPrice=str_replace(',', '', $rsFea['price_paid']);
