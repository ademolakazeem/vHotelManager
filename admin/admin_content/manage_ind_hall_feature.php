                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-lg-4 col-sm-4">
                                  <h2>View Hall Features</h2>

                              </div>
                              <div class="col-lg-8 col-sm-8">
                                  <ol class="breadcrumb pull-right">
                                      <li><a href="index.php">Home</a></li>
                                      <li><a href="view_hall_features.php">Show Hall Features</a></li>
                                      <li class="active">View Hall Features</li>
                                  </ol>
                              </div>
                          </div>
                      </div>
                                ...
                                <div class="form">
                                  ...
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="POST" action="">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                             <?php echo $rsEditHallFea['feature_name'];?>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <?php echo $rsEditHallFea['feature_description'];?>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6">
                                                  ...
                                                  $dispRate=str_replace(',', '', $rsEditHallFea['feature_rate']);
                                                   echo number_format(floatval($dispRate),2);?>
