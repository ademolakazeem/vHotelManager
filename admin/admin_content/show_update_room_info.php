                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-8 col-sm-8">
                                 <ol class="breadcrumb pull-right">
                                     ...
                                     <li class="active">Show Room Setup</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
...
<li><input class="checkbox2" type="checkbox" name="check[]" value="item6"> Do not select this</li>
                          ...
                          <div class="panel-body">
                              ...
                              <tr>
                                <td>
                                      <a href="manage_room_setup.php?room_id=<?php echo $rsRmStup['room_id'];?>" title="Administer <?php echo $rsRmStup['room_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
                                 </td>
