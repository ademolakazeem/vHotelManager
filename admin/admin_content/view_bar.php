                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <tr>
                                  <!--td class="gradeX"-->
                                  <td>
                                      <a href="manage_ind_bar.php?itm_id=<?php echo $rsBar['bar_item_id'];?>" title="Administer <?php echo $rsBar['item_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
