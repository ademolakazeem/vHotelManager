...
<li><input class="checkbox2" type="checkbox" name="check[]" value="item6"> Do not select this</li>
                          ...
                          <div class="panel-body">
                              ...
                              <tr>
                                <td>
                                      <a href="manage_ind_hall_setup.php?hll_Number=<?php echo $rsHllStup['hall_number'];?>" title="Administer <?php echo $rsHllStup['hall_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
                                 </td>
