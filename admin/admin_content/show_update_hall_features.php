                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-8 col-sm-8">
                                 <ol class="breadcrumb pull-right">
                                     ...
                                     <li class="active">Show Hall Features</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Administer Hall Feature Information
                          </header>
                          <div class="panel-body">
                              ...
                              <tr>
                                  <!--td class="gradeX"-->
                                  <td>
                                      <a href="manage_hall_feature.php?hallFea_id=<?php echo $rsFea['hall_feature_id'];?>" title="Administer <?php echo $rsFea['feature_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
