                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Edit Accommodation Feature Information
                          </header>
                                ...
                                <div class="form">
                                  ...
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="POST" action="">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="form-control" id="feature_name" name="feature_name" type="text"
                                                     ...
                                                     value="<?php echo $rsEditAccFea['feature_name'];?>"/>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <textarea class="form-control" id="full_description" name="full_description"><?php echo $rsEditAccFea['full_description'];?></textarea>

                                             <!-- <textarea class="form-control" id="full_description" name="full_description" style="margin: 0px -1px 0px 0px; width: 533px; height: 195px;">
