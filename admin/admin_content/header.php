              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                          ...
                          <img src="<?php echo  $rsAva['imagepathavatar']; ?>" alt="" width="29px" height="29px">

                          <span class="username"><?php if($_SESSION['userfullname']) echo $_SESSION['userfullname']; ?></span>
                          <b class="caret"></b>
                      </a>
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li><a href="upload.php"><i class="fa fa-cog"></i> Upload Picture</a></li>
