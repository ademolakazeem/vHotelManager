...
$hallFea_id = $_GET['hallFea_id'];
//@$item_id=$_GET['item_id'];

 //= "SELECT * FROM hall_reservation_tbl WHERE hall_reservation_id ";
$selQry="SELECT * FROM hall_feature_tbl where hall_feature_id = '$hallFea_id'";
$rsEditHallFea = $db->fetchArrayData($selQry);


if(isset($_POST['update']))
{
    $msg = $adm->updateHallFeat();
}
                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-lg-4 col-sm-4">
                                  <h2>Manage Hall Features</h2>

                              </div>
                              <div class="col-lg-8 col-sm-8">
                                  <ol class="breadcrumb pull-right">
                                      <li><a href="index.php">Home</a></li>
                                      <li><a href="show_update_hall_features.php">Show Hall Features</a></li>
                                      <li class="active">Manage Hall Features</li>
                                  </ol>
                              </div>
                          </div>
                      </div>
                              ...
                              <?php if(isset($msg)) echo $msg; ?>
                                ...
                                <div class="form">
                                  ...
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="POST" action="">
                                      <input name="feature_id" type="hidden" id="feature_id" value="<?php echo $hallFea_id; ?>">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="form-control" id="feature_name" name="feature_name" type="text"

                                                     value="<?php echo $rsEditHallFea['feature_name'];?>"/>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <textarea class="form-control" id="full_description" name="full_description"><?php echo $rsEditHallFea['feature_description'];?></textarea>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="form-control rate"  id="rate" name="rate" type="text"
                                                  <?php
                                                  //$delimiter=',';
                                                  $dispRate=str_replace(',', '', $rsEditHallFea['feature_rate']);
                                                  ?>
                                                     value="<?php echo number_format(floatval($dispRate),2);?>" />
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="form-control rate"  id="discount" name="discount" type="text"
                                                     ...
                                                     ?>
                                                     value="<?php echo number_format(floatval($dispDiscount),2);?>"                                                />
