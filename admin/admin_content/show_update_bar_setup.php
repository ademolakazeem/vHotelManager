                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-8 col-sm-8">
                                 <ol class="breadcrumb pull-right">
                                     ...
                                     <li class="active">Show Bar Setup</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <tr>
                                  <!--td class="gradeX"-->
                                  <td>
                                      <a href="manage_bar_setup.php?itm_id=<?php echo $rsBar['item_id'];?>" title="Administer <?php echo $rsBar['item_name'];?>"><img src="assets/advanced-datatable/examples/examples_support/details_open.png"></a>
