...
$selQry = "SELECT * FROM company_info_tbl";
$rsEditCoyStUp = $db->fetchArrayData($selQry);

if(isset($_POST['updateCoy']))
{
                                  ...
                                  <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class=" form-control" id="coyName" name="coyName" type="text"
                                                     value="<?php echo $rsEditCoyStUp['coy_name']; ?>"
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6">
                                              <!--  class="form-control"-->
                                              <textarea name="coyAddress" id="coyAddress"  cols="6" rows="5" class="form-control" style="text-align: left">
                                                 <?php echo $rsEditCoyStUp['coy_address']; ?>
                                              </textarea>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="numbaOnly form-control" id="coyPhone" name="coyPhone" type="text"
                                                     value="<?php echo $rsEditCoyStUp['coy_phone']; ?>"
                                                  />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class=" form-control" id="coyEmail" name="coyEmail" type="text"
                                                     value="<?php echo $rsEditCoyStUp['coy_email']; ?>"
                                                  />
                                          </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-6">
                                              <input class="form-control" id="webAddress" name="webAddress" type="text"
                                                     value="<?php echo $rsEditCoyStUp['web_address']; ?>"
                                                  />
                                          </div>
                                      </div>
                                     <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-danger" type="submit" id="updateCoy" name="updateCoy">Update Company Information Now</button>
